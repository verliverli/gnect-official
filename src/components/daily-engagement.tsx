...
export function DailyEngagement() {
  ...
  if (loading) {
    return (
      <div className="flex gap-2.5 px-4 py-2 overflow-x-auto gnect-scroll shrink-0">
        {[1, 2, 3].map((i) => (
          <div key={i} className="rounded-xl border border-border bg-card p-3 min-w-[160px] animate-pulse">
  ...
  // ========================================
  return (
    <div className="flex gap-2.5 px-4 py-2 overflow-x-auto gnect-scroll shrink-0 snap-x snap-mandatory">
      {/* 🔥 Daily Dare Card */}
      {dare && (
        <div className="rounded-xl border border-green-500/20 bg-green-500/5 p-3 min-w-[200px] max-w-[220px] snap-start shrink-0">
      ...
      {/* 💬 Hot Take Card */}
      {hotTake && (
        <div className="rounded-xl border border-border bg-card p-3 min-w-[220px] max-w-[260px] snap-start shrink-0">
          <div className="flex items-center gap-1.5 mb-1.5">
            <span className="text-sm">💬</span>
      ...
      {/* 🔥 Streak + Pulse Card */}
      <div className="rounded-xl border border-border bg-card p-3 min-w-[160px] max-w-[180px] snap-start shrink-0">
        <div className="flex items-center gap-1.5 mb-1.5">
          <span className="text-sm">🔥</span>
          <span className="text-[10px] font-semibold text-foreground/60 uppercase tracking-wider">
            Streak
